...
import OmnidirectionalBodyPanel from './components/OmnidirectionalBodyPanel.jsx'
...
const PANELS = ['upload', 'imaging', 'checkin', 'family', 'record', 'matrix3dBody', 'omnidirectionalBody', 'twin', 'telemedicine', 'statAnalysis', 'swarm', 'consensus']
...
export default function App() {
  ...
  const panelLabels = {
    ...
    omnidirectionalBody: t('omnidirectionalBody'),
    twin: t('twin'),
    ...
    <div style={{ display: 'flex', flexDirection: 'column', height: '100vh', overflow: 'hidden' }}>
      ...
      <div style={{ display: 'flex', flex: 1, overflow: 'hidden' }}>
        ...
        <main ref={mainRef} style={{ flex: 1, overflowY: 'auto', background: mainBg }}>
          ...
          {active === 'omnidirectionalBody' && <OmnidirectionalBodyPanel onNext={goNext} onPrev={goPrev} prevLabel={prevLabel} />}
