...
function UserUuid3DAvatar({ uuid, isDark, vi, accent = '#00b8cc' }) {
  ...
  return (
    <div
      ...
      style={{
        flex: '1 1 138px', minWidth: 138, height: 154, borderRadius: 22, position: 'relative', overflow: 'hidden',
    ...
    >
      ...
      <div style={{ position: 'absolute', left: 12, right: 12, bottom: 10, display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 8 }}>
        <span style={{ color: isDark ? '#dbeafe' : '#1f2937', fontSize: 10, fontWeight: 900 }}>{vi ? 'Avatar 3D' : '3D Avatar'}</span>
