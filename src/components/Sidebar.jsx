...
export default function Sidebar({ active, onNavigate, openSignal = 0 }) {
  ...
  const STEPS = [
    ...
    { id: 'upload',    label: t('uploadRecords'),   step: '04' },
    { id: 'imaging',    label: t('imaging'),        step: '05' },
    { id: 'checkin',   label: t('checkin'),         step: '06' },
    { id: 'family',    label: t('familyTree'),      step: '07' },
    { id: 'record',    label: t('patientRecord'),   step: '08' },
    { id: 'familyRelationship', label: t('familyRelationship'), step: '09' },
    { id: 'matrix3dBody', label: t('matrix3dBody'), step: '10' },
    { id: 'omnidirectional3dBody', label: t('omnidirectional3dBody'), step: '11' },
    { id: 'twin',      label: t('twin'),            step: '12' },
    { id: 'telemedicine', label: t('telemedicine'), step: '13' },
    { id: 'statAnalysis', label: t('statAnalysis'), step: '14' },
    { id: 'swarm',      label: t('swarmCouncil'),    step: '15' },
    ...
    { id: 'healthJourneyGame', label: 'Health Journey Game', step: '24' },
  ]
