...
export default function Sidebar({ active, onNavigate, openSignal = 0 }) {
  ...
  const STEPS = [
    ...
    { id: 'wikiMedVision',          label: t('wikiMedVision'),           step: '01c' },
    { id: 'fullDocSummarization',   label: 'Full-Document Summarization', step: '01d' },
    ...
    { id: 'upload',    label: t('uploadRecords'),   step: '05' },
    { id: 'imaging',    label: t('imaging'),        step: '06' },
    { id: 'checkin',   label: t('checkin'),         step: '07' },
    { id: 'family',    label: t('familyTree'),      step: '08' },
    { id: 'record',    label: t('patientRecord'),   step: '09' },
    { id: 'familyRelationship', label: t('familyRelationship'), step: '10' },
    { id: 'matrix3dBody', label: t('matrix3dBody'), step: '11' },
    { id: 'omnidirectional3dBody', label: t('omnidirectional3dBody'), step: '12' },
    { id: 'twin',      label: t('twin'),            step: '13' },
    { id: 'telemedicine', label: t('telemedicine'), step: '14' },
    { id: 'statAnalysis', label: t('statAnalysis'), step: '15' },
    { id: 'swarm',      label: t('swarmCouncil'),    step: '16' },
